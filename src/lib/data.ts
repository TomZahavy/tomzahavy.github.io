...
const pubTags: Record<string, { domains?: string[]; methods?: string[] }> = {
  ...
  "Discovering Policies with DOMiNO: Diversity Optimization Maintaining Near Optimality": { methods: ["Diversity", "Intrinsic reward"] },
  "Discovery of Options via Meta-Learned Subgoals": { methods: ["Hierarchical RL", "Meta RL", "Intrinsic reward"] },
  ...
  "Diversifying AI: Towards Creative Chess with AlphaZero (AlphaZero db)": { methods: ["Diversity", "Aesthetics", "Planning", "Intrinsic reward"], domains: ["Chess", "Games"] },
  "Discovering a set of policies for the worst case reward": { methods: ["Diversity", "Intrinsic reward"] },
  ...
  "Discovering Diverse Nearly Optimal Policies with Successor Features": { methods: ["Diversity", "Intrinsic reward"] },
  ...
  "Online Apprenticeship Learning": { methods: ["Intrinsic reward"] },
  "Inverse Reinforcement Learning in Contextual MDPs": { methods: ["Intrinsic reward"] },
  "ReLOAD: Reinforcement Learning with Optimistic Ascent-Descent for Last-Iterate Convergence in Constrained MDPs": { methods: ["Intrinsic reward"] },
  "Apprenticeship Learning via Frank-Wolfe": { methods: ["Intrinsic reward"] },
};
